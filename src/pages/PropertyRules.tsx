...
const PropertyRules = () => {
  return (
    <section
      data-aos="fade-in"
      className="bg-gradient-to-r from-[var(--color-dark)] via-[var(--color-card)] to-[var(--color-dark)] text-[var(--color-text)] px-6 md:px-20 py-16 max-w-4xl mx-auto my-30 rounded-lg shadow-sm"
    >
      {/* Header */}
